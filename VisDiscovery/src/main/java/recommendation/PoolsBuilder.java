...
public class PoolsBuilder {
	...
	public DropDownResponse getAll(String tableName) throws ClassNotFoundException, SQLException {
		...
		response.dimensionAttrPool.add("career_level");
		response.dimensionAttrPool.add("currency");
		response.dimensionAttrPool.add("job_categories");
		response.dimensionAttrPool.add("city_name");
		
		response.measureAttrPool.add("salary_minimum");
		response.measureAttrPool.add("salary_maximum");
		response.measureAttrPool.add("applicants_count");
		response.measureAttrPool.add("views");
		response.measureAttrPool.add("num_vacancies");
		
	
		  
		response.specificAttrPool.add("job_categories");
