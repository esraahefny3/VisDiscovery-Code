...
public class VisList {
	...
	public void inputs(@FormParam("xAxis") String xAxis, @FormParam("yAxis") String yAxis,
			...
			@FormParam("secondSelector") String secondSelector, @FormParam("SameDimention") String theSameDimention,  
			@FormParam("sameMeasure") String theSameMeasure, @FormParam("sameAggregate") String thesameAggregate ){
		...
		this.sameDimention = theSameDimention;
		this.sameMeasure =theSameMeasure;
		this.sameAggrigate =thesameAggregate;
